{smcl}
{hline 80}
{bf PROGRAM:} {cmd:pea_table14}
{hline 80}
{title:Title}
  {bf pea_table14} — Generates Poverty and Equity Analysis Tables

{title:Syntax}
  {cmd:pea_table14} [{it:if}] [{it:in}], {cmdab:Country(string)} {cmdab:Year(varname numeric)} {cmdab:Indicator(varname)} 
  {cmdab:excel(string)} {cmdab:save(string)}

{title:Description}
  {cmd:pea_table14} calculates and generates tables of poverty and equity-related indicators for poverty analysis. It extracts data for specified countries and years, and produces a detailed table summarizing poverty and inequality measures, including poverty headcount ratio, income distribution, and equity indices. Results can be exported to Excel or saved in a specified file format.
...
{title:Details}
  {cmd:pea_table14} imports relevant poverty and equity datasets, extracts the country-specific and region-specific data for the selected year, and generates a table with:
