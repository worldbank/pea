...
{* 10Nov2024}{...}
{hline}
help for {hi:pea figure9c}{right:March 2025}
{hline}

{title:Title}

{p 4 15}
{bf:pea figure9c} —  Benchmark countries ranked by Gini index.
...
{p 4 4 2}
{opt pea figure9c} shows benchmark countries ranked by Gini index.
...
{p 4 4 2} 
{bf: pea figure9c} [aw=weight_p], c(GNB) year(year) benchmark(CIV GHA GMB SEN) onewelfare(welfare) welfaretype(CONS) 
