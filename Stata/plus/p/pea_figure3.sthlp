...
{* 10Nov2024}{...}
{hline}
help for {hi:pea figure3}{right:January 2025}
{hline}

{title:Title}

{p 4 15}
{bf:pea figure3} —  Generates Growth Incidence Curves (GIC).
...
{p 4 4 2}
{opt pea figure3} generates Growth Incidence Curves (GIC), which display the annualized growth in welfare 
...
{p 4 4 2}
{bf: pea figure3} [aw=weight_p], year(year) welfare(welfppp) spells(2015 2016; 2016 2017;2018 2022;2017 2022)
